...
# Set the hostname
NEW_HOSTNAME="iac-${name}-apne1-$PRIVATE_IP_DASHED"
...
mkdir /home/scsadmin/keys



chown -R scsadmin:scsadmin /home/scsadmin/keys
chmod 600 /home/scsadmin/keys/key_access.pem

# Restart the SSH service
# service ssh restart
systemctl restart sshd
echo ${public_ip} > /etc/public_ip

apt install ansible -y
mkdir -p /etc/ansible/keys /etc/ansible/playbooks /etc/ansible/roles
cp /home/scsadmin/keys/key_access.pem /etc/ansible/keys/key_access.pem
